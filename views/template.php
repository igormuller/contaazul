<?php $array = explode('/', $_SERVER['REQUEST_URI']); $url = array_slice($array, 2); ?>
<html>
    <head>
        <meta charset="utf-8">
        ...
        <div class="wrapper">
            ...
            <header class="main-header">
                ...
                <a href="<?php echo BASE_URL; ?>" class="logo">
                    ...
                    <span class="logo-lg">Conta Azul</span>
                </a>
            ...
            <aside class="main-sidebar">
                ...
                <section class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="<?php echo (in_array("permission",$url))? "active":""; ?>">
                            <a href="<?php echo BASE_URL; ?>/permission"><i class="fa fa-gears"></i> <span>Permissões</span></a>
                        </li>
                        <li class="<?php echo (in_array("user",$url))? "active":""; ?>">
                            <a href="<?php echo BASE_URL; ?>/user"><i class="fa fa-users"></i> <span>Usuários</span></a>
                        </li>
            ...
            <footer class="main-footer">
                ...
                <!-- Default to the left -->
                <strong>Copyright &copy; 2017 <a href="#">IDMweb</a>.</strong> Todos os direitos reservados.
            </footer>
            ...
            <aside class="control-sidebar control-sidebar-dark">
                ...
                <ul class="nav nav-tabs nav-justified control-sidebar-tabs">
                    <li class="active"><a href="#control-sidebar-permission-tab" data-toggle="tab"><i class="fa fa-gear"></i></a></li>
                    <li><a href="#control-sidebar-group-permission-tab" data-toggle="tab"><i class="fa fa-gears"></i></a></li>
                </ul>
                <!-- Tab panes -->
                <div class="tab-content">
                    <!-- Home tab content -->
                    <div class="tab-pane active" id="control-sidebar-permission-tab">
                        <h3 class="control-sidebar-heading">Lista de Permissões</h3>
                    ...
                    <div class="tab-pane" id="control-sidebar-group-permission-tab">
                        <form method="post">
                            <h3 class="control-sidebar-heading">Grupo de Permissões</h3>
